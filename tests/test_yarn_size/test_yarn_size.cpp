...
static void test_extending_with_all_parallel_warps () {
    ...
    for(uint32_t y = 0; y < params->pattern_height; y++){
        ...
        for(uint32_t x = 0; x < params->pattern_width; x++){
            printf("%d",
                params->pattern[x+y*params->pattern_width].warp_above);
        }
        printf(" ]\n");
    }*/
...
static void setup() {
    ...
    for(uint32_t y = 0; y < params->pattern_height; y++){
        printf("[ ");
        for(uint32_t x = 0; x < params->pattern_width; x++){
            printf("%d", params->pattern[x+y*params->pattern_width].yarn_type);
        }
        printf(" ]\n");
    }
    printf("(numbers in pattern indicate yarn type) \n \n");
    printf("Yarn types: \n");
    for(uint32_t i = 0; i < params->num_yarn_types; i++){
        printf("%d: \n",i);
        printf("    yarnsize: %f \n", params->yarn_types[i].yarnsize);
        printf("    spec_strength: %f \n", params->yarn_types[i].specular_strength);
    }
    printf("\n");
    ...
    for(uint32_t y = 0; y < params->pattern_height; y++){
        ...
        for(uint32_t x = 0; x < params->pattern_width; x++){
            printf("%d",
                params->pattern[x+y*params->pattern_width].yarn_type);
        }
        printf(" ]\n");
    }
    printf("(numbers in pattern indicate yarn type) \n \n");
